...
const ServiceDepannage = () => {
    ...
    return (
        <div className={"w-full grid-cols-1 grid lg:grid-cols-3 gap-2 lg:gap-4"}>
            {!loading && datas.map(d =>
                <div className="card bg-primary text-white m-1 lg:m-4 lg:basis-1/4 shadow-xl" key={d.id}>
